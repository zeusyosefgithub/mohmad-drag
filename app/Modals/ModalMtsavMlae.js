            ...
            <ModalContent>
                <>
                    ...
                    <ModalFooter>
                        ...
                        <Button isDisabled={!BdekatMlaeHdash()} isLoading={loading} size="lg" color="primary" onClick={async () => {
                            setLoading(true);
                            let countUp = 0;
                            let countDown = 0;
                            ...
                            await updateDoc(doc(firestore, 'metadata', 'counterHkhnsotAhrot'), {
                                ...
                                countAll : (counterHkhnsotAhrot?.munth !== format(new Date(), 'MM-yyyy')) ? counterHkhnsotAhrot?.count + (-countUp + countDown) : counterHkhnsotAhrot?.countAll,
