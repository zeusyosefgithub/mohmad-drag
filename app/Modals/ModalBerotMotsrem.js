...
export default function ModalBerotMotsrem({ show, disable,motsaremLhatseg,shlav,GetError, motsaremRglem,mlae,category, motsaremBrofelem, setMotsaremRglem, setMotsaremBrofelem }) {
